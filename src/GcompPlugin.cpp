...
#include <GcompPlugin/GcompPlugin.h>
...
bool XBotPlugin::GcompPlugin::init_control_plugin(XBot::Handle::Ptr handle)
{
...
void XBotPlugin::GcompPlugin::on_start(double time)
{
...
void XBotPlugin::GcompPlugin::control_loop(double time, double period)
{
    /* Fix period */
    period = 0.002;
...
void XBotPlugin::GcompPlugin::sync_model()
{
