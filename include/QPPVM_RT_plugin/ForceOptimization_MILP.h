...
//////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    for(auto cl : _contact_links){
        ...
        _aux_var.emplace_back(opt.getVariable(cl+"_slack_ub")/opt.getVariable(cl+"_slack_lb"));
       ...
       _force_MILP_ub.push_back( boost::make_shared<OpenSoT::constraints::GenericConstraint>(cl+"force_MILP_ub",
        ...
        OpenSoT::AffineHelper force_MILP_lb = - 0.001 * force_dot.tail(1) - M * opt.getVariable(cl+"_t");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
     ...
     for(int i = 0; i < _contact_links.size(); i++)
     {      
     task_MILP   << _force_MILP_ub[i] << _force_MILP_lb[i];
     } 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
    ...
    _solver = boost::make_shared<OpenSoT::solvers::iHQP>(_autostack->getStack(), _autostack->getBounds(), 1e-6, solver_vector);
    
/* MILP solver: SET INTEGER VARIABLES */
     
     /* GLPK */  
     OpenSoT::solvers::GLPKBackEnd::GLPKBackEndOptions opt_GLPK;
     opt_GLPK.var_id_kind_.push_back(std::pair<int,int>(0,GLP_BV));
     opt_GLPK.var_id_kind_.push_back(std::pair<int,int>(10,GLP_BV));
     opt_GLPK.var_id_kind_.push_back(std::pair<int,int>(20,GLP_BV));
     opt_GLPK.var_id_kind_.push_back(std::pair<int,int>(30,GLP_BV));
...
//         Fc[i] =  dFc[i] ;     
       ...
       _force_MILP_ub[i]->setBounds( -Fc[i].tail(1) + MILP_ub, -Fc[i].tail(1) - MILP_inf);
       _force_MILP_lb[i]->setBounds(  Fc[i].tail(1) + MILP_ub,  Fc[i].tail(1) - MILP_inf);
