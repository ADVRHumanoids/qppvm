...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private:
        ...
        OpenSoT::tasks::GenericLPTask::Ptr task_Lasso;
...
//     OpenSoT::tasks::Aggregated::Ptr aggr1 = ( 1e-20 * min_slack + _forza_giusta + task_Lasso); 
//     
...
//     _solver = boost::make_shared<OpenSoT::solvers::iHQP>(_autostack->getStack(), _autostack->getBounds(), 0.0, solver_vector);
    _solver = boost::make_shared<OpenSoT::solvers::iHQP>(_autostack->getStack(), _autostack->getBounds(), 0.0, OpenSoT::solvers::solver_back_ends::OSQP);
